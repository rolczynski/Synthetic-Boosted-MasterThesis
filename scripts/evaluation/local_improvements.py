...
base_distances, syn_distances = pickle.load(open('improvements.bin', 'rb'))


def plot(ax, h, title=''):
    labels = ['1', '2', '3', '4', '5', '5+']
    sns.heatmap(h.astype(int), square=True, xticklabels=labels, yticklabels=labels, vmax=25,
...
plt.tight_layout()
plt.savefig('evaluation-improvements.png')
